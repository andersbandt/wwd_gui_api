...
# TODO: either this file has to live here or my common import statement has to change to run my script files from a CLI

# TODO: I hate the separate script_data folder as well, combine with serial_data ??

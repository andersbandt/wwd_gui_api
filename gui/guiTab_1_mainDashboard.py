...
class tabMainDashboard(ThemedFrame):
    def __init__(self, master, class_controller, basefilepath, theme_file):
        ...
        # self.frame = tk.Frame(self.master, bg=self.theme_config["background"])
    ...
    def init_fr_relay_control(self):
        ...
        btn2 = Button(fr_m, bg="orange", text=f"Refresh states", command=lambda: self.gui_refresh_relay_state("call"))
